" splinter | dark greenish vim theme by n0mad
"
" based on fogbell by Jared Gorski
...
let g:colors_name="splinter_dark"
...
let s:voidBlue = {'gui': '#699B9B', 'cterm256': '75'}
...
let s:voidOrange = {'gui': '#FF0000', 'cterm256': '208'}
...
call <sid>hi('Number', 		s:voidBlue, s:none, 'none')
...
call <sid>hi('Todo', 		s:voidBlack, s:voidOrange, 'bold')
...
call <sid>hi('cNumbers', 			s:voidBlue, s:none, 'none')
